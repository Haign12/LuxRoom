const products = [
  ...
  { id: 2, name: "Creamy Bed", price: 680, tone: "thumb-b", category: "Seating", room: "Rest", materialGroup: "Textile", colors: ["Cream"], materials: ["Textile"] },
  ...
  { id: 4, name: "Stone Bathtub", price: 230, tone: "thumb-d", category: "Light & form", room: "Rest", materialGroup: "Stone", colors: ["Cream"], materials: ["Stone"] },
  { id: 5, name: "Studio Desk", price: 210, tone: "thumb-e", category: "Tables", room: "Living", materialGroup: "Oak & ash", colors: ["Natural oak"], materials: ["Oak & ash"] },
  ...
  { id: 13, name: "Olive Desk Lamp", price: 160, tone: "thumb-m", category: "Light & form", room: "Living", materialGroup: "Stoneware", colors: ["Olive green"], materials: ["Stoneware"] },
  { id: 14, name: "Amber Wall Sconce", price: 120, tone: "thumb-n", category: "Light & form", room: "Rest", materialGroup: "Stoneware", colors: ["Terracotta"], materials: ["Stoneware"] },
  { id: 15, name: "Linen Throw", price: 95, tone: "thumb-o", category: "Textiles", room: "Rest", materialGroup: "Textile", colors: ["Cream"], materials: ["Textile"] },
  { id: 16, name: "Oak Keepsake Box", price: 145, tone: "thumb-p", category: "Light & form", room: "Living", materialGroup: "Oak & ash", colors: ["Natural oak"], materials: ["Oak & ash"] },
];
